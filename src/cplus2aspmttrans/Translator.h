...
private:
	...
	bool translateContConst0(bcplus::symbols::ConstantSymbol const* sym, Context* c, std::ostream& out, bool args, ClauseList const* setArgs = NULL);
	bool translateContConstT(bcplus::symbols::ConstantSymbol const* sym, Context* c, std::ostream& out, bool args, ClauseList const* setArgs = NULL);
	...
	bool translate(bcplus::elements::Formula const* f, Context* c, std::ostream& out, bool cont=false, bool zero=false);
	bool translate(bcplus::elements::AtomicFormula const* af, Context* c, std::ostream& out, bool cont=false, bool zero=false, bool negate = false);

	bool translate(bcplus::elements::Term const* t, Context* c, std::ostream& out, bool cont=false, bool zero=false);

	bool check(bcplus::elements::Formula const* f, Context* c, std::ostream& out);
	bool check(bcplus::elements::AtomicFormula const* af, Context* c, std::ostream& out, bool negate = false);

	bool check(bcplus::elements::Term const* t, Context* c, std::ostream& out);

	/// Translate equality into an atomic formula
	bool translate_eq(bcplus::elements::Constant const* constant, std::string const& value, Context* c, std::ostream& out, bool cont=false, bool zero=false);
	bool translate_eq(bcplus::symbols::ConstantSymbol const* constant, std::string const& value, Context* c, std::ostream& out, ClauseList const* setArgs = NULL, bool cont=false, bool zero=false);
	...
	bool bindAndTranslate(bcplus::elements::Formula const* f, Context* c, std::ostream& out, bool parens = true, bool cont=false, bool zero=false);
	bool checkBindAndTranslate(bcplus::elements::Formula const* f, Context* c, std::ostream& out, bool parens = true);


	/// add a translation of the provided object-sort binding as a prereq statement to the provided context
	bool translateObjectDeclaration(bcplus::symbols::ObjectSymbol const* obj, bcplus::symbols::SortSymbol const* sort, Context* c, bool lastObject, bool lastObjDecl);
